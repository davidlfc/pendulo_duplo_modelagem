...
title("diferença de theta 1 (M1 - M2)", 'fontsize', 5);
xlabel("t(s)", 'fontsize', 3);
...
title("diferença de theta 2 (M1 - M2)", 'fontsize', 5);
xlabel("t(s)", 'fontsize', 3);
...
title("diferença de theta 1 ponto (M1 - M2)", 'fontsize', 5);
xlabel("t(s)", 'fontsize', 3);
...
title("diferença de theta 2 ponto (M1 - M2)", 'fontsize', 5);
xlabel("t(s)", 'fontsize', 3);
